...
// COMMENTS TO GRADER: 
// I tried to make a white christmas theme scene but hopefully this works.
// ============================================================
...
static const char outImageFile1[] = "img_spheres.png";
...
// Define materials.
    ...
    // Light green.
    scene.material[1].k_d = Color( 0.0f, 0.5f, 0.0f );
...
void DefineScene2( Scene &scene, int imageWidth, int imageHeight )
{
    ...
    scene.amLight.I_a = Color( 1.0f, 1.0f, 1.0f ) * 0.1f;
...
// Define materials.
    ...
    // Gray.
    scene.material[4].k_d = Color( 1.0f, 1.0f, 1.0f );
    scene.material[4].k_a = scene.material[0].k_d;
    scene.material[4].k_r = Color( 0.6f, 0.6f, 0.6f );
    scene.material[4].k_rg = Color( 0.8f, 0.8f, 0.8f ) / 3.0f;
    scene.material[4].n = 128.0f;
    ...
    scene.ptLight[0].position = Vector3d( 300.0, 200.0, 300.0 );
    ...
    scene.surfacep[13] = new Plane( 0.0, 0.0, 1.0, 0.0, &(scene.material[4]) ); // Right vertical plane.
    scene.surfacep[14] = new Plane( 1.0, 0.0, 0.0, 0.0, &(scene.material[4]) ); // Right vertical plane.


    // Christmas Tree
    scene.surfacep[1] = new Triangle( Vector3d( 75.0, 100.0, 75.0 ), Vector3d( 75.0, 0.0, 25 ),
                                      Vector3d( 75.0, 0.0, 125.0 ), &(scene.material[1]) );
    scene.surfacep[2] = new Triangle( Vector3d( 25.0, 0.0, 75.0 ), Vector3d( 125.0, 0.0, 75.0 ),
                                      Vector3d( 75.0, 100.0, 75.0 ), &(scene.material[1]) );
    

    // 'Star'
    scene.surfacep[3] = new Sphere( Vector3d( 75.0, 110.0, 75.0 ), 10, &(scene.material[3]) );
    
    
    // Christmas Tree decor
    
    
    scene.surfacep[4] = new Sphere( Vector3d( 77.5, 50.0, 80.0 ), 2.5, &(scene.material[0]) );
    
    scene.surfacep[5] = new Sphere( Vector3d( 77.5, 25.0, 85.0 ), 2.5, &(scene.material[0]) );
    
    scene.surfacep[6] = new Sphere( Vector3d( 77.5, 37.5, 100.0 ), 2.5, &(scene.material[0]) );
    
    scene.surfacep[7] = new Sphere( Vector3d( 77.5, 10.0, 110.0 ), 2.5, &(scene.material[0]) );
    
    scene.surfacep[8] = new Sphere( Vector3d( 77.5, 75.0, 85.0 ), 2.5, &(scene.material[0]) );
    
    scene.surfacep[9] = new Sphere( Vector3d( 85, 60.0, 77.5 ), 2.5, &(scene.material[0]) );

    scene.surfacep[10] = new Sphere( Vector3d( 100.0, 50, 77.5 ), 2.5, &(scene.material[0]) );

    scene.surfacep[11] = new Sphere( Vector3d( 85.0, 12.5, 77.5 ), 2.5, &(scene.material[0]) );
    
    scene.surfacep[12] = new Sphere( Vector3d( 95, 37.5, 77.5 ), 2.5, &(scene.material[0]) );


    // Define camera.

    scene.camera = Camera( Vector3d( 300.0, 50, 300.0 ), Vector3d( 75, 50, 75 ), Vector3d( 0.0, 1.0, 0.0 ),
                   (-1.0 * imageWidth) / imageHeight, (1.0 * imageWidth) / imageHeight, -1.0, 1.0, 3.0,
                   imageWidth, imageHeight );
